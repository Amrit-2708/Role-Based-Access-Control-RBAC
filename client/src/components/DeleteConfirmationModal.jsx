...
export default function Example({ id, closeDeleteModal }) {
    ...
    return (
        <Dialog open={open} onClose={closeDeleteModal} className="relative z-10">
            <DialogBackdrop
                transition
                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            Are you sure you want to delete this user? All their data will be permanently removed and
